...
func (r *ClusterResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Error updating Cluster", "GetClusterRequest failed: "+err.Error())
		return
	}
	updateTo := &v2.Cluster{
				...
				Spec: &v1alpha13.ControlPlaneSpec{
					Components: &v1alpha13.ControlPlaneComponentSet{
									...
									a[i] = &v1alpha12.K8SObjectOverlay{
										...
										Patches: func() []*v1alpha12.K8SObjectOverlay_PathValue {
											...
											for i, patches := range overlays.Patches {
												a[i] = &v1alpha12.K8SObjectOverlay_PathValue{Path: patches.Path.ValueString()}
											}
											return a
										}(),
									}
						...
						Istio: &v1alpha13.Istio{
							...
							DefaultWorkloadCert_TTL: &durationpb.Duration{
								Nanos:   int32(model.InstallTemplate.Helm.Spec.Components.Istio.DefaultWorkloadCert_TTL.Nanos.ValueInt64()),
								Seconds: model.InstallTemplate.Helm.Spec.Components.Istio.DefaultWorkloadCert_TTL.Seconds.ValueInt64(),
							},
							...
							MaxWorkloadCert_TTL: &durationpb.Duration{
								Nanos:   int32(model.InstallTemplate.Helm.Spec.Components.Istio.MaxWorkloadCert_TTL.Nanos.ValueInt64()),
								Seconds: model.InstallTemplate.Helm.Spec.Components.Istio.MaxWorkloadCert_TTL.Seconds.ValueInt64(),
							},
						...
						RateLimitServer: &v1alpha13.RateLimitServer{
							Backend: &v1alpha13.RateLimitServer_Backend{},
											...
											for i, revisions := range isolation_boundaries.Revisions {
												a[i] = &v1alpha13.IstioRevision{
													...
													Istio: &v1alpha13.Istio{
														...
														DefaultWorkloadCert_TTL: &durationpb.Duration{
															Nanos:   int32(revisions.Istio.DefaultWorkloadCert_TTL.Nanos.ValueInt64()),
															Seconds: revisions.Istio.DefaultWorkloadCert_TTL.Seconds.ValueInt64(),
														},
														KubeSpec: &kubernetes.KubernetesIstioComponentSpec{
															CNI: &kubernetes.CNI{
														...
														MaxWorkloadCert_TTL: &durationpb.Duration{
															Nanos:   int32(revisions.Istio.MaxWorkloadCert_TTL.Nanos.ValueInt64()),
															Seconds: revisions.Istio.MaxWorkloadCert_TTL.Seconds.ValueInt64(),
														},
														PilotOverlays: func() []*v1alpha12.K8SObjectOverlay {
					...
					MeshExpansion: &v1alpha13.MeshExpansionSettings{
						...
						Onboarding: &v1alpha13.MeshExpansionSettings_OnboardingPlane{
							...
							TokenIssuer:     &v1alpha13.MeshExpansionSettings_OnboardingPlane_TokenIssuer{},
					...
					TelemetryStore:    &v1alpha13.ControlPlaneSpec_TelemetryStore{},
	...
	_, err = r.client.UpdateCluster(ctx, updateTo)
	if err != nil {
		resp.Diagnostics.AddError("Error updating Cluster", "UpdateCluster failed: "+err.Error())
		return
	}
